# TicketIA — Guía para agentes y nuevos desarrolladores

Este documento es el traspaso de conocimiento del proyecto: qué es, cómo está
construido, cómo se verifica y qué queda por hacer. Léelo entero antes de tocar
código. Los datos sensibles del entorno local (credenciales de desarrollo,
endpoints privados) están en `AGENTS.local.md`, que no se sube al repositorio.
