...
<div class="support-shell">
    ...
    <header class="support-topbar">
        ...
        <div><span class="support-eyebrow">Inteligencia operativa</span><h1>Analisis del trabajo activo</h1><p class="subtitulo">Hasta 60 incidencias priorizadas, sin cargar el historico.</p></div>
    ...
    <div class="page-shell">
        ...
        <div class="incidencia-box compact-box">
            ...
            <div class="analysis-stream pretty" id="resumen-content">
                <div class="loading" id="loading">Pulsa «Generar analisis» para crear un resumen actualizado.</div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let source = null;
    const streamUrl = <?= json_encode('analisis.php?' . http_build_query(array_merge($_GET, ['stream' => 1])), JSON_UNESCAPED_SLASHES) ?>;
    const iniciarAnalisis = () => {
        if (source) source.close();
        rawText = '';
        streamStoppedByUser = false;
        loading.style.display = 'block';
        loading.textContent = 'Analizando el trabajo activo...';
