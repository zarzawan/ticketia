...
$sql_tipos = "SELECT tipo, COUNT(*) as total FROM incidencias WHERE tipo = 'Seguridad' AND estado IN ('abierta','en_curso','esperando_cliente') GROUP BY tipo";
$stmt_tipos = $pdo->query($sql_tipos);
$datos_tipos = $stmt_tipos->fetchAll(PDO::FETCH_ASSOC);

$sql_urgencias = "SELECT urgencia, COUNT(*) as total FROM incidencias WHERE tipo = 'Seguridad' AND estado IN ('abierta','en_curso','esperando_cliente') GROUP BY urgencia";
$stmt_urgencias = $pdo->query($sql_urgencias);
$datos_urgencias = $stmt_urgencias->fetchAll(PDO::FETCH_ASSOC);

$sql_estados = "SELECT estado, COUNT(*) as total FROM incidencias WHERE tipo = 'Seguridad' AND estado IN ('abierta','en_curso','esperando_cliente') GROUP BY estado";
