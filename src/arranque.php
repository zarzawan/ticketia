...
if (PHP_SAPI !== 'cli') {
    ...
    if (!in_array($pagina_actual, $paginas_publicas, true)) {
        ...
        if (in_array($pagina_actual, ['admin_operacion.php','admin_reglas.php','admin_calendario.php','admin_predicciones.php','admin_ia_operativa.php','admin_correo_entrante.php'], true)) auth_requerir_rol('admin');
