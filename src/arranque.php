...
if (PHP_SAPI !== 'cli') {
    ...
    if (!in_array($pagina_actual, $paginas_publicas, true)) {
        ...
        $paginas_cliente = ['portal.php', 'portal_ver.php', 'ayuda.php', 'buscar_ayuda.php', 'valorar_servicio.php', 'mi_cuenta.php', 'guardar_incidencia.php', 'guardar_mensaje.php', 'subir_adjunto.php', 'descargar_adjunto.php', 'confirmar_resolucion.php', 'logout.php'];
