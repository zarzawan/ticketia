...
if (PHP_SAPI !== 'cli') {
    ...
    if (!in_array($pagina_actual, $paginas_publicas, true)) {
        ...
        $paginas_admin = ['admin_inicio.php', 'admin_usuarios.php', 'admin_clientes.php', 'admin_flujos.php', 'admin_catalogo.php', 'admin_auditoria.php', 'admin_ajustes.php', 'cambiar_proveedor.php', 'reprocesar_incidencias.php', 'ver_logs_llm.php'];
